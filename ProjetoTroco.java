...
public class ProjetoTroco {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String caixaTMP="CAIXA\n";
            for (Caixa caixaX : caixa) {
                caixaTMP+=caixaX.getQtde()+"  R$ "+df.format(caixaX.getValor())+"\n";
            }
            
            leitura = JOptionPane.showInputDialog(caixaTMP+"\nInforme o valor! [Exemplo 3.50]\n");
